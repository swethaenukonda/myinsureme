...
stage('Docker Image Push') {
       steps {
        withCredentials([string(credentialsId: 'docker-hub2', variable: ''), usernamePassword(credentialsId: 'dockerhub2', passwordVariable: 'dockerhub-password', usernameVariable: 'dockerhub-user')]) {
